...
{openManage && (
<ManageTaskModal task={task} onClose={onCloseManage} onTaskUpdate={onTaskUpdate} />
)}
</>
);
}
...
function ManageTaskModal({ task, onClose, onTaskUpdate }: { task: Task; onClose: () => void; onTaskUpdate: (t: Task) => void }) {
